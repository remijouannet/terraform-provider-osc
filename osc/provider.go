...
func Provider() terraform.ResourceProvider {
	...
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"osc_alb":                      dataSourceAwsAlb(),
			"osc_alb_listener":             dataSourceAwsAlbListener(),
			"osc_ami":                      dataSourceAwsAmi(),
			"osc_autoscaling_groups":       dataSourceAwsAutoscalingGroups(),
			...
			"osc_cloudformation_stack":     dataSourceAwsCloudFormationStack(),
			"osc_db_instance":              dataSourceAwsDbInstance(),
			"osc_ebs_snapshot":             dataSourceAwsEbsSnapshot(),
			"osc_ebs_volume":               dataSourceAwsEbsVolume(),
			"osc_ecs_cluster":              dataSourceAwsEcsCluster(),
			"osc_ecs_container_definition": dataSourceAwsEcsContainerDefinition(),
			"osc_ecs_task_definition":      dataSourceAwsEcsTaskDefinition(),
			...
			"osc_redshift_service_account": dataSourceAwsRedshiftServiceAccount(),
			"osc_region":                   dataSourceAwsRegion(),
			"osc_route_table":              dataSourceAwsRouteTable(),
			"osc_route53_zone":             dataSourceAwsRoute53Zone(),
			...
			"osc_kms_secret":               dataSourceAwsKmsSecret(),
		},

		ResourcesMap: map[string]*schema.Resource{
			"osc_alb":                                      resourceAwsAlb(),
			"osc_alb_listener":                             resourceAwsAlbListener(),
			"osc_alb_listener_rule":                        resourceAwsAlbListenerRule(),
			"osc_alb_target_group":                         resourceAwsAlbTargetGroup(),
			"osc_alb_target_group_attachment":              resourceAwsAlbTargetGroupAttachment(),
			...
			"osc_api_gateway_deployment":                   resourceAwsApiGatewayDeployment(),
			"osc_api_gateway_domain_name":                  resourceAwsApiGatewayDomainName(),
			...
			"osc_appautoscaling_target":                    resourceAwsAppautoscalingTarget(),
			"osc_appautoscaling_policy":                    resourceAwsAppautoscalingPolicy(),
			"osc_autoscaling_attachment":                   resourceAwsAutoscalingAttachment(),
			"osc_autoscaling_group":                        resourceAwsAutoscalingGroup(),
			"osc_autoscaling_notification":                 resourceAwsAutoscalingNotification(),
			"osc_autoscaling_policy":                       resourceAwsAutoscalingPolicy(),
			"osc_autoscaling_schedule":                     resourceAwsAutoscalingSchedule(),
			"osc_cloudformation_stack":                     resourceAwsCloudFormationStack(),
			"osc_cloudfront_distribution":                  resourceAwsCloudFrontDistribution(),
			"osc_cloudfront_origin_access_identity":        resourceAwsCloudFrontOriginAccessIdentity(),
			"osc_cloudtrail":                               resourceAwsCloudTrail(),
			"osc_cloudwatch_event_rule":                    resourceAwsCloudWatchEventRule(),
			"osc_cloudwatch_event_target":                  resourceAwsCloudWatchEventTarget(),
			"osc_cloudwatch_log_group":                     resourceAwsCloudWatchLogGroup(),
			"osc_cloudwatch_log_metric_filter":             resourceAwsCloudWatchLogMetricFilter(),
			"osc_cloudwatch_log_stream":                    resourceAwsCloudWatchLogStream(),
			"osc_cloudwatch_log_subscription_filter":       resourceAwsCloudwatchLogSubscriptionFilter(),
			"osc_autoscaling_lifecycle_hook":               resourceAwsAutoscalingLifecycleHook(),
			"osc_cloudwatch_metric_alarm":                  resourceAwsCloudWatchMetricAlarm(),
			"osc_codedeploy_app":                           resourceAwsCodeDeployApp(),
			"osc_codedeploy_deployment_config":             resourceAwsCodeDeployDeploymentConfig(),
			"osc_codedeploy_deployment_group":              resourceAwsCodeDeployDeploymentGroup(),
			"osc_codecommit_repository":                    resourceAwsCodeCommitRepository(),
			"osc_codecommit_trigger":                       resourceAwsCodeCommitTrigger(),
			"osc_codebuild_project":                        resourceAwsCodeBuildProject(),
			"osc_customer_gateway":                         resourceAwsCustomerGateway(),
			"osc_db_event_subscription":                    resourceAwsDbEventSubscription(),
			"osc_db_instance":                              resourceAwsDbInstance(),
			"osc_db_option_group":                          resourceAwsDbOptionGroup(),
			"osc_db_parameter_group":                       resourceAwsDbParameterGroup(),
			"osc_db_security_group":                        resourceAwsDbSecurityGroup(),
			"osc_db_subnet_group":                          resourceAwsDbSubnetGroup(),
			"osc_directory_service_directory":              resourceAwsDirectoryServiceDirectory(),
			"osc_dms_certificate":                          resourceAwsDmsCertificate(),
			"osc_dms_endpoint":                             resourceAwsDmsEndpoint(),
			"osc_dms_replication_instance":                 resourceAwsDmsReplicationInstance(),
			"osc_dms_replication_subnet_group":             resourceAwsDmsReplicationSubnetGroup(),
			"osc_dms_replication_task":                     resourceAwsDmsReplicationTask(),
			"osc_dynamodb_table":                           resourceAwsDynamoDbTable(),
			"osc_ebs_snapshot":                             resourceAwsEbsSnapshot(),
			"osc_ebs_volume":                               resourceAwsEbsVolume(),
			"osc_ecr_repository":                           resourceAwsEcrRepository(),
			"osc_ecr_repository_policy":                    resourceAwsEcrRepositoryPolicy(),
			"osc_ecs_cluster":                              resourceAwsEcsCluster(),
			"osc_ecs_service":                              resourceAwsEcsService(),
			"osc_ecs_task_definition":                      resourceAwsEcsTaskDefinition(),
			"osc_efs_file_system":                          resourceAwsEfsFileSystem(),
			"osc_efs_mount_target":                         resourceAwsEfsMountTarget(),
			"osc_eip":                                      resourceAwsEip(),
			"osc_eip_association":                          resourceAwsEipAssociation(),
			"osc_elasticache_cluster":                      resourceAwsElasticacheCluster(),
			"osc_elasticache_parameter_group":              resourceAwsElasticacheParameterGroup(),
			"osc_elasticache_replication_group":            resourceAwsElasticacheReplicationGroup(),
			"osc_elasticache_security_group":               resourceAwsElasticacheSecurityGroup(),
			"osc_elasticache_subnet_group":                 resourceAwsElasticacheSubnetGroup(),
			"osc_elastic_beanstalk_application":            resourceAwsElasticBeanstalkApplication(),
			"osc_elastic_beanstalk_configuration_template": resourceAwsElasticBeanstalkConfigurationTemplate(),
			"osc_elastic_beanstalk_environment":            resourceAwsElasticBeanstalkEnvironment(),
			"osc_elasticsearch_domain":                     resourceAwsElasticSearchDomain(),
			"osc_elasticsearch_domain_policy":              resourceAwsElasticSearchDomainPolicy(),
			"osc_elastictranscoder_pipeline":               resourceAwsElasticTranscoderPipeline(),
			"osc_elastictranscoder_preset":                 resourceAwsElasticTranscoderPreset(),
			"osc_elb":                                      resourceAwsElb(),
			"osc_elb_attachment":                           resourceAwsElbAttachment(),
			"osc_emr_cluster":                              resourceAwsEMRCluster(),
			"osc_emr_instance_group":                       resourceAwsEMRInstanceGroup(),
			"osc_flow_log":                                 resourceAwsFlowLog(),
			"osc_glacier_vault":                            resourceAwsGlacierVault(),
			...
			"osc_inspector_assessment_target":              resourceAWSInspectorAssessmentTarget(),
			"osc_inspector_assessment_template":            resourceAWSInspectorAssessmentTemplate(),
			"osc_inspector_resource_group":                 resourceAWSInspectorResourceGroup(),
			"osc_instance":                                 resourceAwsInstance(),
			"osc_internet_gateway":                         resourceAwsInternetGateway(),
			"osc_key_pair":                                 resourceAwsKeyPair(),
			"osc_kinesis_firehose_delivery_stream":         resourceAwsKinesisFirehoseDeliveryStream(),
			"osc_kinesis_stream":                           resourceAwsKinesisStream(),
			...
			"osc_lightsail_domain":                         resourceAwsLightsailDomain(),
			"osc_lightsail_instance":                       resourceAwsLightsailInstance(),
			"osc_lightsail_key_pair":                       resourceAwsLightsailKeyPair(),
			...
			"osc_opsworks_application":                     resourceAwsOpsworksApplication(),
			"osc_opsworks_stack":                           resourceAwsOpsworksStack(),
			"osc_opsworks_java_app_layer":                  resourceAwsOpsworksJavaAppLayer(),
			"osc_opsworks_haproxy_layer":                   resourceAwsOpsworksHaproxyLayer(),
			"osc_opsworks_static_web_layer":                resourceAwsOpsworksStaticWebLayer(),
			"osc_opsworks_php_app_layer":                   resourceAwsOpsworksPhpAppLayer(),
			"osc_opsworks_rails_app_layer":                 resourceAwsOpsworksRailsAppLayer(),
			"osc_opsworks_nodejs_app_layer":                resourceAwsOpsworksNodejsAppLayer(),
			"osc_opsworks_memcached_layer":                 resourceAwsOpsworksMemcachedLayer(),
			"osc_opsworks_mysql_layer":                     resourceAwsOpsworksMysqlLayer(),
			"osc_opsworks_ganglia_layer":                   resourceAwsOpsworksGangliaLayer(),
			"osc_opsworks_custom_layer":                    resourceAwsOpsworksCustomLayer(),
			"osc_opsworks_instance":                        resourceAwsOpsworksInstance(),
			"osc_opsworks_user_profile":                    resourceAwsOpsworksUserProfile(),
			"osc_opsworks_permission":                      resourceAwsOpsworksPermission(),
			"osc_opsworks_rds_db_instance":                 resourceAwsOpsworksRdsDbInstance(),
			"osc_placement_group":                          resourceAwsPlacementGroup(),
			"osc_proxy_protocol_policy":                    resourceAwsProxyProtocolPolicy(),
			"osc_rds_cluster":                              resourceAwsRDSCluster(),
			"osc_rds_cluster_instance":                     resourceAwsRDSClusterInstance(),
			"osc_rds_cluster_parameter_group":              resourceAwsRDSClusterParameterGroup(),
			"osc_redshift_cluster":                         resourceAwsRedshiftCluster(),
			"osc_redshift_security_group":                  resourceAwsRedshiftSecurityGroup(),
			"osc_redshift_parameter_group":                 resourceAwsRedshiftParameterGroup(),
			"osc_redshift_subnet_group":                    resourceAwsRedshiftSubnetGroup(),
			"osc_route53_delegation_set":                   resourceAwsRoute53DelegationSet(),
			"osc_route53_record":                           resourceAwsRoute53Record(),
			"osc_route53_zone_association":                 resourceAwsRoute53ZoneAssociation(),
			"osc_route53_zone":                             resourceAwsRoute53Zone(),
			"osc_route53_health_check":                     resourceAwsRoute53HealthCheck(),
			...
			"osc_ses_active_receipt_rule_set":              resourceAwsSesActiveReceiptRuleSet(),
			"osc_ses_receipt_filter":                       resourceAwsSesReceiptFilter(),
			"osc_ses_receipt_rule":                         resourceAwsSesReceiptRule(),
			"osc_ses_receipt_rule_set":                     resourceAwsSesReceiptRuleSet(),
			"osc_ses_configuration_set":                    resourceAwsSesConfigurationSet(),
			"osc_ses_event_destination":                    resourceAwsSesEventDestination(),
			...
			"osc_simpledb_domain":                          resourceAwsSimpleDBDomain(),
			"osc_ssm_activation":                           resourceAwsSsmActivation(),
			"osc_ssm_association":                          resourceAwsSsmAssociation(),
			"osc_ssm_document":                             resourceAwsSsmDocument(),
			"osc_spot_datafeed_subscription":               resourceAwsSpotDataFeedSubscription(),
			"osc_spot_instance_request":                    resourceAwsSpotInstanceRequest(),
			"osc_spot_fleet_request":                       resourceAwsSpotFleetRequest(),
			"osc_sqs_queue":                                resourceAwsSqsQueue(),
			"osc_sqs_queue_policy":                         resourceAwsSqsQueuePolicy(),
			"osc_snapshot_create_volume_permission":        resourceAwsSnapshotCreateVolumePermission(),
			"osc_sns_topic":                                resourceAwsSnsTopic(),
			"osc_sns_topic_policy":                         resourceAwsSnsTopicPolicy(),
			"osc_sns_topic_subscription":                   resourceAwsSnsTopicSubscription(),
			"osc_sfn_activity":                             resourceAwsSfnActivity(),
			"osc_sfn_state_machine":                        resourceAwsSfnStateMachine(),
			...
			"osc_waf_byte_match_set":                   resourceAwsWafByteMatchSet(),
			"osc_waf_ipset":                            resourceAwsWafIPSet(),
			"osc_waf_rule":                             resourceAwsWafRule(),
			"osc_waf_size_constraint_set":              resourceAwsWafSizeConstraintSet(),
			"osc_waf_web_acl":                          resourceAwsWafWebAcl(),
			"osc_waf_xss_match_set":                    resourceAwsWafXssMatchSet(),
			"osc_waf_sql_injection_match_set":          resourceAwsWafSqlInjectionMatchSet(),
		},
